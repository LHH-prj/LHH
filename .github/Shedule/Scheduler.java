...
//		border.setStyle("-fx-background-color :palegreen"
//				+ "linear-gradient(to bottom, #BBBBCC 30%, #AAAAAA 100%);");
//		
//		TableColumn<EventList,Date> date01=new TableColumn<EventList,Date>("날짜");
		...
		//border.getChildren().addAll(dp,table);
//		border.setPrefSize(400, 220);
//		
