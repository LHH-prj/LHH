...
public class Controller implements Initializable{
	...
	public void identifyOk(ActionEvent event) throws IOException {
		...
		System.out.println(cashMon.rootStage.get(0));
		
		Parent par = (Parent)cashMon.rootStage.get(0);
		Stage sta = (Stage)par.getScene().getWindow();
		sta.close();
...
//		Parent root = loader.load();
		...
		System.out.println(cashMon.loginId.get(0));
		
		String s1 = (String)cashMon.loginId.get(0);
		
		System.out.println(s1);
		
		dbsrv.Insert(s1);
		
		System.out.println("dbsrv.Insert(); 끝");
